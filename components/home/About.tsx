...
const FUN_FACTS = [
  { dot: "bg-indigo-400", text: "KIIT" },
  { dot: "bg-pink-400", text: "HACK" },
  { dot: "bg-amber-400", text: "SUN" },
  { dot: "bg-green-400", text: "MUS" },
  { dot: "bg-sky-400", text: "BSG" },
  { dot: "bg-orange-400", text: "IN" },
];
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {FUN_FACTS.map((f) => (
              <span
                key={f.text}
                className="liquid-glass rounded-full px-3 py-1 text-xs font-body text-white/50 flex items-center gap-1.5"
              >
